...
def PrimaryCap(inputs, matrix_dims_in_capsule, n_channels, kernel_size, strides, padding):
    """
    ...
    activations = layers.Conv2D(filters= n_channels, kernel_size=kernel_size, strides=strides, padding=padding, activation='sigmoid',
                           name='primarycap_activation')(inputs)

    return poses, activations

def CapsulesConv(poses, activations, n_channels, kernel_size, strides, padding):
